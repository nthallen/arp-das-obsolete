...
# Truncates the message when it is replied with and checks to see if
# the correct trucated message is received by the Send function.
...
if ( ($pid=fork) == 0 ) {
	$rpid = QNX::Receive($pid, $rvmsg, $ssize);
